    ...
    return html`
      ...
      <div id="container">
        ...
        <div id="content">
          ${this._htmlHeader()}
          <div>
            ${this.currentPage == PAGES.LANDING_PAGE ? html`
              <div class="slot"><slot></slot></div>
            `:``}

            ${!this.isEmpty(this.libraryContent) && this.currentPage != PAGES.LANDING_PAGE ? html`
              <library-grid
              ...
              ></library-grid>
            `:``}
            ${this.isEmpty(this.libraryContent) && this.currentPage == PAGES.LIBRARY_PAGE ? html`
              <div class="loading-spinner"></div>
            `:``}

            ${!this.isEmpty(this.currentMedia) && this.currentPage == PAGES.MEDIA_PAGE ? html`
              <media-modal
